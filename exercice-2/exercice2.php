    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                <p class="text-center fs-4">Faire une fonction qui prend en paramètre une chaine de caractères et qui retourne cette même chaine. </p>
