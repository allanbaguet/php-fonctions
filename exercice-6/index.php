...
function exercice6($lastname, $firstname, $age) {
    $response = 'Bonjour' . ' ' . $lastname . ' ' . $firstname . ' ' . ', tu as' . ' ' . $age . ' ' . 'ans.';
    return $response;
}
$result = exercice6($lastname, $firstname, $age);
?>
<!DOCTYPE html>
<html lang="fr">
        ...
        <div class="row">
            <div class="col">
                ...
                <p class="text-center fs-4">
                    Faire une fonction qui prend trois paramètres : le nom, le prénom et l'âge d'une personne. Elle doit renvoyer une chaine de la forme : <br>
                    Bonjour + <strong>nom</strong> + <strong>prénom</strong> + , tu as + <strong>age</strong> + ans.
                </p>
            </div>
        </div>
    </div>
